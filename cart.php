...
<html>
    ...
    <head>
    <title>Dashboard | User Cart</title>
    </head>
    <style>
    body{
...
$que="SELECT * FROM cart where username='$user'";
...
{
echo "<tr>";
echo "<td>".$rec1['isbn']."<td>";
$new=$rec1['isbn'];
$que2="SELECT * FROM book where isbn=$new";
$rec2=mysqli_query($con,$que2);
$rec3=mysqli_fetch_assoc($rec2);
echo "<td><a href=\"http://localhost/example/Ecommerce/BOOKS/dispbook.php?isbn=$new\">".$rec3['name']."</td>";
